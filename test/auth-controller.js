...
//             };
//             mongoose.connect('mongodb+srv://vlajko:vlajko@cluster0-jqd2k.mongodb.net/test-reports?retryWrites=true&w=majority', options)
//             .then(result => {
//                 const user = new User({
//                     name: 'testtest',
//                     email: 'test@mail.com',
...
//             console.log('provera praznog polja');
//         })
